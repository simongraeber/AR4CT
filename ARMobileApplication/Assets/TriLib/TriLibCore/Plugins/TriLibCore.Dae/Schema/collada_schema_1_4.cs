...
//    [DebuggerStepThrough]
    ...
    [DesignerCategory("code")]
    [XmlType(Namespace = "http://www.collada.org/2005/11/COLLADASchema")]
    public class InputLocalOffset : COLLADAItemWithSemantic
    {
    ...
    [DesignerCategory("code")]
    [XmlType(Namespace = "http://www.collada.org/2005/11/COLLADASchema")]
    public class InputLocal : COLLADAItemWithSemantic
    {
        private string semanticField;
    ...
    [XmlType(AnonymousType = true, Namespace = "http://www.collada.org/2005/11/COLLADASchema")]
    [XmlRoot(Namespace = "http://www.collada.org/2005/11/COLLADASchema", IsNullable = false)]
    public class source : COLLADAFieldWithID
    {
        private asset assetField;
    ...
    [XmlType(AnonymousType = true, Namespace = "http://www.collada.org/2005/11/COLLADASchema")]
    [XmlRoot(Namespace = "http://www.collada.org/2005/11/COLLADASchema", IsNullable = false)]
    public class geometry : COLLADAFieldWithID
    {
        private asset assetField;
    ...
    [XmlType(AnonymousType = true, Namespace = "http://www.collada.org/2005/11/COLLADASchema")]
    [XmlRoot(Namespace = "http://www.collada.org/2005/11/COLLADASchema", IsNullable = false)]
    public class visual_scene : COLLADAFieldWithID
    {
        private asset assetField;
    ...
    public interface COLLADAFieldWithID
    {
        string id { get; set; }
    }

    public interface COLLADAItemWithSemantic
    {
    ...
    public static class COLLADAHelper
    {
        ...
        public static T GetItemWithIdNoHash<T>(this object[] items, string id) where T : class
        {
            foreach (var item in items)
            {
        ...
        public static T GetItemWithId<T>(this T[] items, string id) where T : class
        {
            foreach (var item in items)
            {
                if (item is COLLADAFieldWithID colladaFieldWithId && $"#{colladaFieldWithId.id}" == id)
                {
                    return item;
                } 
                if (item is effect effect && $"#{effect.id}" == id)
                {
                    return item;
                }
                if (item is controller controller && $"#{controller.id}" == id)
                {
                    return item;
                }
            }
        ...
        public static bool HasInputWithSemantic<T>(this T[] items, string semantic) where T : class
        {
            foreach (var item in items)
            {
                if (item is COLLADAItemWithSemantic colladaItemWithSemantic && colladaItemWithSemantic.semantic == semantic)
                {
                    return true;
                }
            }
