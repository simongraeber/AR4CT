...
namespace TriLibCore.Editor
{
    public class TriLibSettingsProvider : SettingsProvider
    {
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            GUILayout.Label("Managed Libraries (TriLibCore.dll, TriLibCore.FBX.dll, etc)", EditorStyles.boldLabel);
            ShowConditionalToggle("Use source code instead of prebuilt libraries (required on Unity 6)", "TRILIB_USE_SOURCE_LIBS");
            EditorGUILayout.Space();
